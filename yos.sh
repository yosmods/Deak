...
echo
echo $pur"==================="$cy" ============================="
echo $i"Ôûê"$pu"  AUTHOR  :  𝐘𝐎𝐒-𝟗𝟗𝟗  "$i"                    Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  GK MAKE"$i"                Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  gantenggood8@gmail.com"$i"     Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  YOS_999"$i"                 Ôûê"
echo $pur"==================="$cy" ============================="
echo
